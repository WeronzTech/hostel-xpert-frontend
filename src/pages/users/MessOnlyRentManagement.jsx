...
const MessOnlyRentManagement = () => {
  ...
  const normalizedJoinDateFilter = useMemo(() => {
    if (!joinDateFilter) return null;
    return dayjs.isDayjs(joinDateFilter)
      ? joinDateFilter
  ...
  }, [searchTerm, statusFilter, joinDateFilter, selectedKitchen?.id]);
